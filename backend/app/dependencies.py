...
def apply_project_scope(query, user: User):
    ...
    # Field officers and MPs need explicit assignment tables before they can be
    # safely granted broad geography-based portfolio access.
    if user.role in {Role.FIELD_OFFICER, Role.MP}:
