...
class User(Base):
    ...
    aadhaar_number: Mapped[str | None] = mapped_column(String(16), nullable=True)
    ...
    biometric_enrolled: Mapped[bool] = mapped_column(Boolean, default=True)
    biometric_device_id: Mapped[str | None] = mapped_column(String(80), nullable=True)
