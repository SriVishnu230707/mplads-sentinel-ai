...
export const projects: Project[] = [
  ...
  { id: 'MPL-KA-24019', title: 'Rural Link Road Upgradation', location: 'Channarayapatna, Bengaluru Rural', state: 'Karnataka', district: 'Bengaluru Rural', constituency: 'Bengaluru Rural', category: 'Roads', agency: 'PWD Bengaluru Rural', sanctioned: 56, spent: 31.4, progress: 58, risk: 42, level: 'Moderate', issue: 'Execution progressing within acceptable variance', updated: '28 min ago', lat: 60, lng: 59, latitude: 13.268, longitude: 77.728 },
